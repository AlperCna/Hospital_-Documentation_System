...
public class DoctorPage extends javax.swing.JFrame {
    ...
    private void jTable_PatientMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_PatientMouseClicked
        ...
        if (evt.getClickCount() == 2 || evt.getButton() == java.awt.event.MouseEvent.BUTTON3) {
            int selectedRow = jTable_Patient.getSelectedRow();
            if (selectedRow != -1) {
                // Retrieve the Patient ID as a String and parse it to an Integer
                String patientIDString = jTable_Patient.getValueAt(selectedRow, 0).toString();
                try {
                    int patientID = Integer.parseInt(patientIDString); // Safely parse to Integer
                    showMedicalRecords(patientID); // Call the method to show medical records
    ...
    private void showMedicalRecords(int patientID) {
        try ( Connection conn = DatabaseConnection.getConnection()) {
            ...
            String query = "SELECT m.RecordDate, d.Specialization, m.Description "
            ...
            // Create a model for the JTable to display medical records
            String[] columnNames = {"Record Date", "Doctor's Specialization", "Description"};
            ...
            // Display the medical records in a new JTable inside a JScrollPane
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error loading medical records.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
